...
Our introduction of a Markov random walk model is an elegant solution we entered into the dialogue. 

Overall, we feel confident in our model's ability to find relevant songs to continue and put together a great playlist. 
